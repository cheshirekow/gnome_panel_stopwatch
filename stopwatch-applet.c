   ...
   gpointer data)
{
    ...
    if (strcmp (iid, "OAFIID:StopwatchApplet") != 0)
        return FALSE;
    ...
    gtk_timeout_add( 1000, timeout_callback, label );
...
PANEL_APPLET_BONOBO_FACTORY ("OAFIID:StopwatchApplet_Factory",
                             PANEL_TYPE_APPLET,
                             "A Simple Stopwatch Applet",
                             "0",
                             stopwatch_applet_fill,
                             NULL);
